...
public class Code {
	Map<String,String> compMap,destMap,jumpMap;
	Code(){
	...
	public String dest(String mnec){
		
		if(destMap.keySet().contains(mnec))
			return (String)destMap.get(mnec);
		else
			return null;
	}
	public String comp(String mnec){
		
		if(compMap.keySet().contains(mnec))
			return (String)compMap.get(mnec);
		else
			return null;
	}
	public String jump(String mnec){
		if(jumpMap.keySet().contains(mnec))
			return (String)jumpMap.get(mnec);
		else
			return null;
	}
}
